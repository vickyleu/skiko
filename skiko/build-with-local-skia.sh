...
#SKIA_VERSION="${SKIA_VERSION:="m121"}" # Version of Skia m###-commit-sha-#. This commit sha will be cloned from repository https://github.com/JetBrains/skia
...
SKIA_TARGET="${SKIA_TARGET:="ios"}" # possible values: "ios", "iosSim", "macos", "windows", "linux", "wasm", "android", "tvos", "tvosSim"
